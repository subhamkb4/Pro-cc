...
TOKEN = "8449023249:AAFy64heD351HNGMJYs8cR9-5GL76sM0iaE"
OWNER_ID = 7896890222
# --- New Configuration ---
...
AUTHORIZED_GROUP_ID = -1003154512032
...
# --- GLOBAL STATE ---
user_last_command = {}
AUTHORIZED_CHATS = set((-1003154512032,))  # Add your authorized group IDs here
...
BULLET_GROUP_LINK = "https://t.me/CARDER3333"
OFFICIAL_GROUP_LINK = "https://t.me/+stkkpQibuW5hYjc9"
DEV_LINK = "https://t.me/NeuroNinjaX"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    image_url = "https://i.ibb.co/mCbV9QFd/file-00000000d5c472089bdb5a99ee2ff555.png"
    try:
...
async def back_to_start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await q.message.reply_photo(
            photo="https://i.ibb.co/mCbV9QFd/file-00000000d5c472089bdb5a99ee2ff555.png", # Re-send the image
            caption=text,
            parse_mode=ParseMode.HTML,
            reply_markup=keyboard
        )
...
async def show_tools_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        f"{bullet_link} 𝐃??𝐫????𝐢𝐨𝐧  : 7 Days\n"
        f"{bullet_link} ??𝐫𝐢𝐜𝐞     : 3$\n"
        "────────────────────────\n"
        "🌟 <b>Premium Plan</b>\n"
...
async def razorpay_gate_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    BULLET_GROUP_LINK = "https://t.me/CARDER3333"  # your clickable bullet link
    bullet_link = f"<a href='{BULLET_GROUP_LINK}'>[⌇]</a>"
...
# ===== Config =====
BULLET_GROUP_LINK = "https://t.me/CARDER3333"
DEVELOPER_NAME = "NᴇᴜʀᴏNɪɴᴊᴀX"
DEVELOPER_LINK = "https://t.me/NᴇᴜʀᴏNɪɴᴊᴀX"
...
async def background_check(cc_normalized, parts, user, user_data, processing_msg):
    ...
    try:
        ...
        final_text = (
            ...
            f"</pre>\n\n"
            f"𝐃𝐄𝐕 ➵ <a href=\"tg://resolve?domain=NᴇᴜʀᴏNɪɴᴊᴀX\">NᴇᴜʀᴏNɪɴᴊᴀX</a>\n"                   
...
async def run_braintree_check(user, cc_input: str, full_card: str, processing_msg):
    start_time = time.time()
    developer_clickable = '<a href="https://t.me/NᴇᴜʀᴏNɪɴᴊᴀX">NᴇᴜʀᴏNɪɴᴊᴀX</a>'
...
async def gate_worker(update: Update, url: str, msg, user_id: int):
    ...
    developer_clickable = "[NᴇᴜʀᴏNɪɴᴊᴀX](https://t.me/NᴇᴜʀᴏNɪɴᴊᴀX)"
    bullet = "[⌇]"
...
# Clickable bullet
BULLET_LINK = '<a href="https://t.me/CARDER3333">[⌇]</a>'
...
async def status_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status_message = (
        ...
        f"{BULLET_LINK} 𝐁𝐨𝐭 𝐁𝐲 ➳ <a href='tg://resolve?domain=NᴇᴜʀᴏNɪɴᴊᴀX'>NᴇᴜʀᴏNɪɴᴊᴀX</a>\n"
        "――――――――――――――――"
    )
...
# 🛡️ Security
AUTHORIZED_CHATS = set([-1003154512032, -1002832894194, -1002996641591, -1002750403340, -1003007390596, -1003040961439, -1002905834316, -1002660201006, -1002397483185, -1001988765966, -1003044358879])  # Only these groups
OWNER_ID =  8318114044                    # Your Telegram user ID

# 🛑 Banned users
BANNED_USERS = set()

# 🔑 Bot token
BOT_TOKEN = "8247782765:AAE3fYoNonKryYhDidYe3mu18hdOVbCm__0"
...
async def block_unauthorized(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "📩 Contact @NᴇᴜʀᴏNɪɴᴊᴀX to get access.\n"
        "🔗 Official group: https://t.me/CARDER3333"
    )
